    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.AddPhoneSuccess ? "El telefono ha sido configurado."
                : message == ManageMessageId.RemovePhoneSuccess ? "El telefono ha sido removido."
                : "";
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            ModelState.AddModelError("", "No se pudo verificar el telefono");
            return View(model);
        }
        ...
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.RemoveLoginSuccess ? "El inicio de sesión ha sido removido."
                : message == ManageMessageId.Error ? "Ha ocurrido un error."
                : "";
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            if (user == null)
